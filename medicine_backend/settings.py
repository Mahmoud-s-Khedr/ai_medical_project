...
OCR_MAX_BIGRAM_CANDIDATES = env.int("OCR_MAX_BIGRAM_CANDIDATES", default=8)
OCR_ENABLE_CONFUSION_NORMALIZATION = env.bool("OCR_ENABLE_CONFUSION_NORMALIZATION", default=True)
...
OCR_NEAR_MISS_RESULT_FLOOR = env.float("OCR_NEAR_MISS_RESULT_FLOOR", default=0.55)
OCR_NEAR_MISS_OCR_CONFIDENCE = env.float("OCR_NEAR_MISS_OCR_CONFIDENCE", default=0.93)
OCR_DEBUG_TOKENS_LOG = env.bool("OCR_DEBUG_TOKENS_LOG", default=False)
